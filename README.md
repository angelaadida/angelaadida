...
Currently at Accenture Technology Solutions (Kuala Lumpur), with hands-on exposure to AI/ML data operations. Holding a U.S.-accredited Master of Data Science (Birchwood University), with certifications from Stanford, AWS, Johns Hopkins, Microsoft, and OpenAI Academy.
...
- 🤖 Project focus: AI Agents & Automation, RAG systems, LLMs, Computer Vision, Predictive ML
- 📊 BI tools: Power BI (DAX), Tableau — from financial dashboards to model deployment
- 🎓 MDS — Birchwood University (U.S.-Accredited) | Stanford ML Specialization | AWS Cloud Practitioner | Johns Hopkins | OpenAI Academy
...
**Machine Learning:** TensorFlow, PyTorch, Scikit-learn, Deep Learning, NLP, Computer Vision, Time Series Forecasting

**Generative AI & Agents:** LLMs, Prompt Engineering, RAG (Vector DBs, Semantic Search), Agentic AI, AI Agents & Workflow Automation, Claude API, MCP (Model Context Protocol), LangChain, LlamaIndex, OpenAI API, Hugging Face, Ollama

**BI & Visualization:** Power BI (DAX), Tableau, KPI Dashboard Development

**Cloud & DevOps:** AWS, Docker, FastAPI, Flask, Streamlit, RESTful APIs
