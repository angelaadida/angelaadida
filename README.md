...
**Data Scientist | AI/ML Engineer | Open to Opportunities Across Southeast Asia**

Results-driven Data Scientist with 4+ years of experience across banking, technology, and education sectors in Southeast Asia. Specializing in building AI-powered solutions — from predictive models and RAG pipelines to end-to-end BI dashboards that drive strategic decision-making.
...
**AI & Machine Learning:** LangChain, OpenAI API, Hugging Face, TensorFlow, PyTorch, Scikit-learn

**BI & Visualization:** Power BI, Tableau

**Cloud & DevOps:** AWS, Docker, Flask, Streamlit
...
|---|---|---|---|---|
| [bank-loan-amount-prediction-final](https://github.com/angelaadida/bank-loan-amount-prediction-final) | Regression | Bank loan amount prediction — production-grade ML pipeline with correct feature engineering, leakage prevention, hyperparameter tuning & Tableau dashboard | RandomForest, StandardScaler, RandomizedSearchCV, Tableau | R²≈0 (honest result — synthetic dataset with no signal; pipeline is production-ready) |
| [breast-cancer-gradient-xgboost](https://github.com/angelaadida/breast-cancer-gradient-xgboost) | Classification | Cancer classification | GradientBoosting, XGBoost | 97% |
...
| [earthquake-classification](https://github.com/angelaadida/earthquake-classification) | Classification | Tsunami prediction with tuning | RandomForest, GridSearchCV | 91% |
...
| [housing-price-prediction](https://github.com/angelaadida/housing-price-prediction) | Regression | Boston EDA & California housing regression | RandomForest | R²=0.80 |
...
| [co2-direct-forecasting](https://github.com/angelaadida/co2-direct-forecasting) | Regression | CO2 multi-step time series — Direct strategy | Direct Strategy, LinearRegression | R²=0.99/0.95/0.89 |
| [co2-recursive-forecasting](https://github.com/angelaadida/co2-recursive-forecasting) | Regression | CO2 time series — Recursive strategy | Recursive Strategy, LinearRegression | R²=0.99 |
...
| [mnist-pca-dimensionality-reduction](https://github.com/angelaadida/mnist-pca-dimensionality-reduction) | Dimensionality Reduction | PCA on 70K MNIST images | PCA, NumPy | 784→100 dims |
...
| Project | Description | Tech |
|---|---|---|
| [rag-pdf-question-answering](https://github.com/angelaadida/rag-pdf-question-answering) | RAG system for PDF Q&A — answers strictly from provided documents, no hallucination | LangChain, FAISS, OpenAI GPT |
| [llm-serving-vllm](https://github.com/angelaadida/llm-serving-vllm) | High-throughput LLM serving with OpenAI-compatible API locally | vLLM, Qwen2.5-1.5B |
| [llm-local-ollama](https://github.com/angelaadida/llm-local-ollama) | Local LLM text generation + image understanding — free, private, offline | Ollama, LLaMA 3.1 8B, LLaMA 3.2 Vision 11B |
...
| Project | Description | Tech |
|---|---|---|
| [Image-Classification-with-ResNet50](https://github.com/angelaadida/Image-Classification-with-ResNet50) | Web app for image classification — top-3 ImageNet predictions | ResNet50, Streamlit |
...
| [Flask_CNN](https://github.com/angelaadida/Flask_CNN) | Fashion MNIST CNN model deployed with Flask | TensorFlow/Keras, Flask |
